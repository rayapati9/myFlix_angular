...
export class MovieCardComponent {
  ...
  addFavorite(_id: string): void {
    this.fetchApiData2.addFavoriteMovie(_id).subscribe(() => {
      this.snackBar.open(`${_id} has been added to your favorites!`, 'OK', {
        duration: 2000,
      });
    });
  }
   ...
   * @param birth
   */
  showDirectorDialog(name: string, age: number): void {
